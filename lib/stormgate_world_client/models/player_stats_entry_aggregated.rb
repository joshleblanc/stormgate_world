...
module StormgateWorldClient
  class PlayerStatsEntryAggregated
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StormgateWorldClient::PlayerStatsEntryAggregated` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StormgateWorldClient::PlayerStatsEntryAggregated`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'matches_per_day')
        self.matches_per_day = attributes[:'matches_per_day']
      else
        self.matches_per_day = nil
      end
    ...
    def list_invalid_properties
      ...
      if @matches_per_day.nil?
        invalid_properties.push('invalid value for "matches_per_day", matches_per_day cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @matches_per_day.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          matches == o.matches &&
          matches_per_day == o.matches_per_day &&
          wins == o.wins &&
          losses == o.losses &&
          ties == o.ties &&
          win_rate == o.win_rate &&
    ...
    def hash
      [matches, matches_per_day, wins, losses, ties, win_rate, mmr, points, match_length].hash
    end
