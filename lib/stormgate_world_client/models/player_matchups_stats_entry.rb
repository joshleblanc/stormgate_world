...
module StormgateWorldClient
  class PlayerMatchupsStatsEntry
    attr_accessor :match_length_range
    ...
    def self.attribute_map
      {
        :'match_length_range' => :'match_length_range',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StormgateWorldClient::PlayerMatchupsStatsEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StormgateWorldClient::PlayerMatchupsStatsEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'match_length_range')
        self.match_length_range = attributes[:'match_length_range']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          match_length_range == o.match_length_range &&
    ...
    def hash
      [match_length_range, matches_count, wins_count, losses_count, wins, losses, ties, win_rate, match_length].hash
    end
